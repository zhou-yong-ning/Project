...
def total_amount(worksheet):
    ...
    listnum = [25, 20, 20, 10, 10, 20, 20, 9, 9, 20,  4,  12, 26, 22, 40, 30]
...
df4012 = df4012[
    ['宅基地代码', '宗地号', '使用权人代表姓名',
     ...
     '户口类型', '成员姓名', '证件号码', '性别', '与户主关系', '数据来源', '是否本集体经济组织成员','通讯地址']]
print(df4012.dtypes)
sava_path = os.path.join(Current_Folder_path, "宗地权利人农户问题汇总表.xlsx")
df4012.to_excel(sava_path, index=False)
print('数据写入成功')
